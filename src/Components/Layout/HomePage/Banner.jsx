  ...
  return (
    <div>
      ...
      <div className="md:w-3/4  backdrop-blur-sm mx-auto bg-black/50 py-5 z-10 md:absolute  top-1/4 rounded-md flex flex-col gap-5 items-center justify-center">
        <h2 className="animate-background text-3xl md:text-7xl font-bold text-center bg-gradient-to-r from-red-400 via-yellow-500 to-pink-500 text-transparent bg-clip-text py-5">Welcome to <br /> the biggest Toy Store </h2>
