...
const Navbar = () => {
    ...
    return (
        <nav className="navbar justify-between py-0 fixed backdrop-blur-md top-0 left-0 z-20 bg-pink-600/20">
            <div className=" w-full justify-between md:justify-normal md:w-3/4 flex-row-reverse md:flex-row ">
                <div className="dropdown dropdown-end">
                    <label tabIndex={0} className="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </label>
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow flex-col w-44 bg-gray-500 rounded-box  right-10 ">
                ...
                <Link to="/" className=" flex justify-between items-center border-none gap-3 px-2 text-xl font-extrabold tracking-wide ">
                    <img className='w-20 h-20 hidden md:block'  src="https://i.ibb.co/27rgTMn/Logo.png" alt="" />
                    Sci-fi-toy</Link>
            </div>
